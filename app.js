// calculator class
class Calculator {
  // this are like variable in cpp amd java but in javascript these variable are present by default
  // means when u use this variable js define before (by default)
  // when use this.variable  it autometically define
  ...
  getDisplaynumber(number) {
    ...
    //split function split the string at dot and store ate index 0
  ...
  chooseOpeartion(operation) {
    if (this.currentOperand === "") return; // if number is not present then operation will not work
